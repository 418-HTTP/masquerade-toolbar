...
(function ($, Drupal, drupalSettings, once) {
  ...
  Drupal.behaviors.masqueradeToolbar = {
    attach: function (context, settings) {
      const toolbars = once('masquerade-toolbar', '.masquerade-toolbar', context);
      ...
      toolbars.forEach(function(toolbar) {
        ...
        const $autocomplete = $toolbar.find('.masquerade-toolbar__autocomplete');
        ...
        autocompleteTimeout = setTimeout(() => {
          $.ajax({
            ...
            success: function (data) {
              ...
              data.forEach(user => {
                const $item = $('<div class="masquerade-toolbar__autocomplete-item"></div>')
                  .text(user.label)
                  .data('uid', user.uid)
                  .data('url', user.url)
                  .on('click', function () {
